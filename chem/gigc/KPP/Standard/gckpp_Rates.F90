...
! Mercury related reactions, yxzhang, 06/22/2019
  REAL(kind=dp) FUNCTION GCHG1( A0,B0,C0 )
      REAL A0,B0,C0 
      GCHG1 =  DBLE(A0) * (TEMP/DBLE(B0)) ** DBLE(C0)
  END FUNCTION GCHG1    

  REAL(kind=dp) FUNCTION GCHG2( A0,B0,C0,D0 )
      REAL A0,B0,C0,D0 
      GCHG2 =  DBLE(A0) * (TEMP/DBLE(B0)) ** DBLE(C0) * EXP(-DBLE(D0)/TEMP)
  END FUNCTION GCHG2    

  REAL(kind=dp) FUNCTION GCHG3( A0,B0 )
      REAL A0,B0
      GCHG3 =  DBLE(A0) * EXP(DBLE(B0)/TEMP)
  END FUNCTION GCHG3    

  REAL(kind=dp) FUNCTION GCHG4( A0,B0,C0 )
      REAL A0,B0,C0
      GCHG4 =  DBLE(A0) * EXP(DBLE(B0)*(1.0E0/TEMP - 1.0E0/DBLE(C0)))
  END FUNCTION GCHG4    

  REAL(kind=dp) FUNCTION GCHG5( A0,B0,C0,D0,E0 )
      REAL A0,B0,C0,D0,E0
      REAL k0NO2, kinfNO2
      REAL p
      k0NO2 = DBLE(A0) * (TEMP/DBLE(B0)) ** DBLE(C0)
      kinfNO2 = DBLE(D0) * EXP(DBLE(E0)/TEMP)
      p = (DBLE(1.0)+(LOG10(k0NO2*NUMDEN/kinfNO2))**DBLE(2.0))**DBLE(-1.0)
      GCHG5 = k0NO2*NUMDEN/(DBLE(1.0)+k0NO2*NUMDEN/kinfNO2)*DBLE(0.6)**p
  END FUNCTION GCHG5
...
! End INLINED RCONST
  ...
  RCONST(537) = (GCHG1(1.46E-32,2.98E+2,-1.86)*NUMDEN*BR_off)
  RCONST(538) = (GCHG2(1.6E-9,2.98E+2,-1.86,7801.0)*NUMDEN)
  RCONST(539) = (GCARR(3.9E-11,0.0E+00,0.0)*BR_off)
  RCONST(540) = (GCHG3(3.4E-12,391.0)*NO2_off)
  RCONST(541) = (GCARR(3.0E-11,0.0E+00,0.0)*BR_off)
  RCONST(542) = (GCHG5(6.91E-29,300.0,-4.5,2.21E-11,497.0)*NO2_off)
  RCONST(543) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*HO2_off)
  RCONST(544) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*OH_off)
  RCONST(545) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*CL_off)
  RCONST(546) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*BRO_off)
  RCONST(547) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*CLO_off)
  RCONST(548) = (GCHG4(2.2E-32,680.0,298.0)*NUMDEN*CL_off)
  RCONST(549) = (GCHG3(1.2E-11,-5942.0)*CL_off)
  RCONST(550) = (GCARR(3.0E-11,0.0E+00,0.0)*BR_off)
  RCONST(551) = (GCHG5(6.91E-29,300.0,-4.5,2.21E-11,497.0)*NO2_off)
  RCONST(552) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*HO2_off)
  RCONST(553) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*OH_off)
  RCONST(554) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*CL_off)
  RCONST(555) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*BRO_off)
  RCONST(556) = (GCHG5(2.21E-29,300.0,-4.37,8.42E-12,625.0)*CLO_off)
  RCONST(557) = (HET(ind_HO2,1))
  RCONST(558) = (HET(ind_NO2,1))
  RCONST(559) = (HET(ind_NO3,1))
  RCONST(560) = (HET(ind_N2O5,1))
  RCONST(561) = (HET(ind_N2O5,2))
  RCONST(562) = (HET(ind_N2O5,3))
  RCONST(563) = (HET(ind_BrNO3,1))
  RCONST(564) = (HET(ind_BrNO3,2))
  RCONST(565) = (HET(ind_ClNO3,1))
  RCONST(566) = (HET(ind_ClNO3,2))
  RCONST(567) = (HET(ind_ClNO3,3))
  RCONST(568) = (HET(ind_ClNO3,4))
  RCONST(569) = (HET(ind_ClNO3,5))
  RCONST(570) = (HET(ind_HOCl,1))
  RCONST(571) = (HET(ind_HOCl,2))
  RCONST(572) = (HET(ind_HOBr,1))
  RCONST(573) = (HET(ind_HOBr,2))
  RCONST(574) = (HET(ind_HOBr,3))
  RCONST(575) = (HET(ind_HOBr,4))
  RCONST(576) = (HET(ind_HOBr,5))
  RCONST(577) = (HET(ind_HOBr,6))
  RCONST(578) = (HET(ind_HOBr,7))
  RCONST(579) = (HET(ind_HCl,1))
  RCONST(580) = (HET(ind_HCl,2))
  RCONST(581) = (HET(ind_O3,1))
  RCONST(582) = (HET(ind_O3,2))
  RCONST(583) = (HET(ind_O3,3))
  ...
  RCONST(591) = (HET(ind_I2O2,1))
  RCONST(592) = (HET(ind_I2O2,2))
  RCONST(593) = (HET(ind_I2O2,3))
  RCONST(594) = (HET(ind_I2O3,1))
  RCONST(595) = (HET(ind_I2O3,2))
  RCONST(596) = (HET(ind_I2O3,3))
  RCONST(597) = (HET(ind_I2O4,1))
  RCONST(598) = (HET(ind_I2O4,2))
  RCONST(599) = (HET(ind_I2O4,3))
  RCONST(600) = (HET(ind_IONO,1))
  RCONST(601) = (HET(ind_IONO,2))
  RCONST(602) = (HET(ind_IONO2,1))
  RCONST(603) = (HET(ind_IONO2,2))
  RCONST(604) = (HET(ind_IONO,3))
  RCONST(605) = (HET(ind_IONO2,3))
  RCONST(606) = (HET(ind_HOI,3))
  RCONST(607) = (HET(ind_GLYX,1))
  RCONST(608) = (HET(ind_MGLY,1))
  RCONST(609) = (HET(ind_IEPOXA,1))
  RCONST(610) = (HET(ind_IEPOXB,1))
  RCONST(611) = (HET(ind_IEPOXD,1))
  RCONST(612) = (HET(ind_IMAE,1))
  RCONST(613) = (HET(ind_LVOC,1))
  RCONST(614) = (HET(ind_ISN1OG,1))
  RCONST(615) = (HET(ind_ISOPND,1))
  RCONST(616) = (HET(ind_ISOPNB,1))
  RCONST(617) = (HET(ind_MACRN,1))
  RCONST(618) = (HET(ind_MVKN,1))
  RCONST(619) = (HET(ind_R4N2,1))
  RCONST(620) = (HET(ind_DHDN,1))
  RCONST(621) = (HET(ind_MONITS,1))
  RCONST(622) = (HET(ind_MONITU,1))
  RCONST(623) = (HET(ind_HONIT,1))
  RCONST(624) = (HET(ind_Hg0,3)*O3_off)
  RCONST(625) = (HET(ind_Hg0,1)*HOCL_off)
  RCONST(626) = (HET(ind_Hg0,2)*OH_off)
  RCONST(627) = (1e-2*HET(ind_Hg2,1))
  RCONST(628) = (1e-2*HET(ind_HgP,1))
  RCONST(629) = (PHOTOL(2))
  RCONST(630) = (PHOTOL(3))
  RCONST(631) = (PHOTOL(1))
  ...
  RCONST(716) = (PHOTOL(102))
  RCONST(717) = (PHOTOL(115))
  RCONST(718) = (PHOTOL(116))
  RCONST(719) = (PHOTOL(117))
  RCONST(720) = (PHOTOL(118))
  RCONST(721) = (PHOTOL(119))
  RCONST(722) = (PHOTOL(120))
  RCONST(723) = (PHOTOL(121))
  RCONST(724) = (PHOTOL(122))
  RCONST(725) = (PHOTOL(123))
  RCONST(726) = (PHOTOL(124))
  RCONST(727) = (PHOTOL(125))
  RCONST(728) = (PHOTOL(126))
  RCONST(729) = (PHOTOL(127))
  RCONST(730) = (PHOTOL(128))
  RCONST(731) = (PHOTOL(129))
  RCONST(732) = (PHOTOL(130))
  RCONST(733) = (PHOTOL(104))
  ...
  RCONST(741) = (PHOTOL(6))
  RCONST(742) = (PHOTOL(106))
  RCONST(743) = (PHOTOL(107))
  RCONST(744) = (PHOTOL(108))
  RCONST(745) = (PHOTOL(109))
  RCONST(746) = (PHOTOL(110))
  RCONST(747) = (PHOTOL(111))
  RCONST(748) = (PHOTOL(112))
  RCONST(749) = (PHOTOL(113))
