...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'PH2O2          ','I2O4           ','HgBr           ', & ! index 37 - 39
     'Hg2            ','Hg0            ','HgCl           ', & ! index 40 - 42
     ...
     'CHCl3          ','CHBr3          ','CH2Br2         ', & ! index 82 - 84
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     ...
     'ISNOOA         ','PO2            ','B3O2           ', & ! index 172 - 174
     'ISOPNDO2       ','HCOOH          ','MACROO         ', & ! index 175 - 177
     'R4N1           ','MAOPO2         ','ISOP           ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(65) :: SPC_NAMES_2 = (/ &
     'H2O2           ','ATO2           ','I              ', & ! index 181 - 183
     'RCO3           ','LIMO2          ','IO             ', & ! index 184 - 186
     'OLND           ','OLNN           ','MACRN          ', & ! index 187 - 189
     'KO2            ','HOBr           ','ISOPNBO2       ', & ! index 190 - 192
     'PIO2           ','HC5OO          ','HNO3           ', & ! index 193 - 195
     'ISOPND         ','NMAO3          ','ACTA           ', & ! index 196 - 198
     'VRO2           ','HOCl           ','ISN1           ', & ! index 199 - 201
     'GLYC           ','CH2OO          ','ClNO3          ', & ! index 202 - 204
     'MGLY           ','ACET           ','HC5            ', & ! index 205 - 207
     'RIO2           ','INO2           ','ETO2           ', & ! index 208 - 210
     'R4O2           ','R4N2           ','HAC            ', & ! index 211 - 213
     'MRO2           ','BrO            ','PRPE           ', & ! index 214 - 216
     'RCHO           ','MEK            ','CH2O           ', & ! index 217 - 219
     'MACR           ','ALD2           ','MVK            ', & ! index 220 - 222
     'MCO3           ','SO2            ','HCl            ', & ! index 223 - 225
     'HBr            ','H2O            ','NO             ', & ! index 226 - 228
     'Br             ','O1D            ','HO2            ', & ! index 229 - 231
     'OH             ','NO3            ','ClO            ', & ! index 232 - 234
     'O              ','O3             ','MO2            ', & ! index 235 - 237
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '    INO2 + NO3 --> LOx + 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MACR + 0.035 MVK + 0.8 HO2 + 1.3 NO', & ! index 64
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '   INO2 + MCO3 --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MACR + 0.035 MVK + 0.8 HO2 + MO2 + 0.3 NO', & ! index 216
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_18 = (/ &
     ...
     '          HgCl --> Hg2                                                                              ', & ! index 556
     '           HO2 --> O2                                                                               ', & ! index 557
     '           NO2 --> 0.5 LOx + 0.5 HNO2 + 0.5 HNO3                                                    ', & ! index 558
     '           NO3 --> LOx + HNO3                                                                       ', & ! index 559
     '    N2O5 + H2O --> LOx + 2 HNO3                                                                     ', & ! index 560
     '    N2O5 + HCl --> LOx + ClNO2 + HNO3                                                               ', & ! index 561
     '          N2O5 --> LOx + ClNO2 + HNO3                                                               ', & ! index 562
     '   BrNO3 + H2O --> HOBr + HNO3                                                                      ', & ! index 563
     '   BrNO3 + HCl --> LOx + BrCl + HNO3                                                                ', & ! index 564
     '   ClNO3 + H2O --> HNO3 + HOCl                                                                      ', & ! index 565
     '   ClNO3 + HCl --> LOx + Cl2 + HNO3                                                                 ', & ! index 566
     '   ClNO3 + HBr --> LOx + BrCl + HNO3                                                                ', & ! index 567
     'BrSALA + ClNO3 --> LOx + BrCl + HNO3                                                                ', & ! index 568
     'BrSALC + ClNO3 --> LOx + BrCl + HNO3                                                                ', & ! index 569
     '    HOCl + HCl --> LOx + Cl2 + H2O                                                                  ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_19 = (/ &
     '    HOCl + HBr --> LOx + BrCl + H2O                                                                 ', & ! index 571
     '    HOBr + HBr --> LOx + Br2 + H2O                                                                  ', & ! index 572
     '    HOBr + HCl --> LOx + BrCl + H2O                                                                 ', & ! index 573
     '          HOBr --> LOx + BrCl + H2O                                                                 ', & ! index 574
     ' BrSALA + HOBr --> LOx + Br2                                                                        ', & ! index 575
     ' BrSALC + HOBr --> LOx + Br2                                                                        ', & ! index 576
     '          HOBr --> SO4H1 + LOx + HBr                                                                ', & ! index 577
     '          HOBr --> SO4H2 + LOx + HBr                                                                ', & ! index 578
     '           HCl --> O2                                                                               ', & ! index 579
     '           HCl --> O2                                                                               ', & ! index 580
     '      HBr + O3 --> HOBr                                                                             ', & ! index 581
     '   BrSALA + O3 --> HOBr                                                                             ', & ! index 582
     '   BrSALC + O3 --> HOBr                                                                             ', & ! index 583
     ...
     '          I2O2 --> 2 AERI + 2 LOx                                                                   ', & ! index 591
     '          I2O2 --> 2 ISALA + 2 LOx                                                                  ', & ! index 592
     '          I2O2 --> 2 ISALC + 2 LOx                                                                  ', & ! index 593
     '          I2O3 --> 2 AERI + 3 LOx                                                                   ', & ! index 594
     '          I2O3 --> 2 ISALA + 3 LOx                                                                  ', & ! index 595
     '          I2O3 --> 2 ISALC + 3 LOx                                                                  ', & ! index 596
     '          I2O4 --> 2 AERI + 4 LOx                                                                   ', & ! index 597
     '          I2O4 --> 2 ISALA + 4 LOx                                                                  ', & ! index 598
     '          I2O4 --> 2 ISALC + 4 LOx                                                                  ', & ! index 599
     '          IONO --> ISALA + LOx                                                                      ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_20 = (/ &
     '          IONO --> ISALC + LOx                                                                      ', & ! index 601
     '         IONO2 --> ISALA + 2 LOx                                                                    ', & ! index 602
     '         IONO2 --> ISALC + 2 LOx                                                                    ', & ! index 603
     '          IONO --> LOx + 0.15 IBr + 0.85 ICl + HNO2                                                 ', & ! index 604
     '         IONO2 --> LOx + 0.15 IBr + 0.85 ICl + HNO3                                                 ', & ! index 605
     '           HOI --> LOx + 0.15 IBr + 0.85 ICl                                                        ', & ! index 606
     '          GLYX --> SOAGX                                                                            ', & ! index 607
     '          MGLY --> SOAMG                                                                            ', & ! index 608
     '        IEPOXA --> SOAIE                                                                            ', & ! index 609
     '        IEPOXB --> SOAIE                                                                            ', & ! index 610
     '        IEPOXD --> SOAIE                                                                            ', & ! index 611
     '          IMAE --> SOAME                                                                            ', & ! index 612
     '          LVOC --> LVOCOA                                                                           ', & ! index 613
     '        ISN1OG --> ISN1OA                                                                           ', & ! index 614
     '        ISOPND --> LOx + IONITA                                                                     ', & ! index 615
     '        ISOPNB --> LOx + IONITA                                                                     ', & ! index 616
     '         MACRN --> LOx + IONITA                                                                     ', & ! index 617
     '          MVKN --> LOx + IONITA                                                                     ', & ! index 618
     '          R4N2 --> LOx + IONITA                                                                     ', & ! index 619
     '          DHDN --> IONITA                                                                           ', & ! index 620
     '        MONITS --> MONITA                                                                           ', & ! index 621
     '        MONITU --> MONITA                                                                           ', & ! index 622
     '         HONIT --> MONITA                                                                           ', & ! index 623
     '           Hg0 --> Hg2                                                                              ', & ! index 624
     '           Hg0 --> Hg2                                                                              ', & ! index 625
     '           Hg0 --> Hg2                                                                              ', & ! index 626
     '           Hg2 --> Hg0                                                                              ', & ! index 627
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_21 = (/ &
     ...
     '          CH2O --> PCO + H + HO2 + CO                                                               ', & ! index 635
     '          CH2O --> PCO + CO + H2                                                                    ', & ! index 636
     '          HNO3 --> OH + NO2                                                                         ', & ! index 637
     '          HNO2 --> NO + OH                                                                          ', & ! index 638
     '          HNO4 --> POx + OH + NO3                                                                   ', & ! index 639
     '          HNO4 --> HO2 + NO2                                                                        ', & ! index 640
     '           NO3 --> O + NO2                                                                          ', & ! index 641
     '           NO3 --> 2 LOx + NO + O2                                                                  ', & ! index 642
     '          N2O5 --> NO3 + NO2                                                                        ', & ! index 643
     '          ALD2 --> 0.88 PCO + 0.12 MCO3 + HO2 + 0.88 MO2 + 0.88 CO                                  ', & ! index 644
     '          ALD2 --> PCO + CH4 + CO                                                                   ', & ! index 645
     '           PAN --> 0.3 POx + 0.7 MCO3 + 0.3 NO3 + 0.3 MO2 + 0.7 NO2                                 ', & ! index 646
     '          RCHO --> PCO + ETO2 + HO2 + CO                                                            ', & ! index 647
     '          ACET --> MCO3 + MO2                                                                       ', & ! index 648
     '          ACET --> PCO + 2 MO2 + CO                                                                 ', & ! index 649
     '           MEK --> 0.15 RCO3 + 0.85 ETO2 + 0.85 MCO3 + 0.15 MO2                                     ', & ! index 650
     '          GLYC --> PCO + 0.9 CH2O + 1.73 HO2 + 0.07 OH + CO + 0.1 MOH                               ', & ! index 651
     '          GLYX --> 2 PCO + 2 HO2 + 2 CO                                                             ', & ! index 652
     '          GLYX --> 2 PCO + 2 CO + H2                                                                ', & ! index 653
     '          GLYX --> PCO + CH2O + CO                                                                  ', & ! index 654
     '          MGLY --> PCO + MCO3 + HO2 + CO                                                            ', & ! index 655
     '           MVK --> PCO + PRPE + CO                                                                  ', & ! index 656
     '           MVK --> PCO + CH2O + MCO3 + HO2 + CO                                                     ', & ! index 657
     '           MVK --> RCO3 + MO2                                                                       ', & ! index 658
     '          MACR --> PCO + CH2O + MCO3 + HO2 + CO                                                     ', & ! index 659
     '           HAC --> CH2O + MCO3 + HO2                                                                ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_22 = (/ &
     '          INPN --> RCHO + HO2 + OH + NO2                                                            ', & ! index 661
     '          PRPN --> RCHO + HO2 + OH + NO2                                                            ', & ! index 662
     ...
     '           IAP --> 0.67 PCO + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + HO2 + OH + 0.67 CO + 0.19 H2       ', & ! index 672
     '          ISNP --> RCHO + HO2 + OH + NO2                                                            ', & ! index 673
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + 0.7 MCO3 + 0.3 HO2 + OH                         ', & ! index 674
     '           MRP --> 0.5 PCO + HAC + 0.5 CH2O + HO2 + OH + 0.5 CO                                     ', & ! index 675
     '          MAOP --> CH2O + MCO3 + OH                                                                 ', & ! index 676
     '          R4N2 --> 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.32 ETO2 + 0.13 RCHO + 0.19 MEK + 0.32 ALD2 ', & ! index 677
     '           MAP --> OH + MO2                                                                         ', & ! index 678
     '         MACRN --> 0.5 PCO + MGLY + HAC + 0.5 CH2O + HO2 + NO2 + 0.5 CO                             ', & ! index 679
     '          MVKN --> GLYC + MCO3 + NO2                                                                ', & ! index 680
     '        ISOPNB --> HC5 + HO2 + NO2                                                                  ', & ! index 681
     '           Br2 --> 2 Br                                                                             ', & ! index 682
     '           BrO --> Br + O                                                                           ', & ! index 683
     '          HOBr --> LOx + Br + OH                                                                    ', & ! index 684
     '         BrNO3 --> Br + NO3                                                                         ', & ! index 685
     '         BrNO3 --> BrO + NO2                                                                        ', & ! index 686
     '         BrNO2 --> Br + NO2                                                                         ', & ! index 687
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_23 = (/ &
     ...
     '          BrCl --> Br + Cl                                                                          ', & ! index 693
     '           Cl2 --> 2 Cl                                                                             ', & ! index 694
     '           ClO --> O + Cl                                                                           ', & ! index 695
     '          OClO --> ClO + O                                                                          ', & ! index 696
     '         Cl2O2 --> 2 LOx + ClOO + Cl                                                                ', & ! index 697
     '         ClNO2 --> NO2 + Cl                                                                         ', & ! index 698
     '         ClNO3 --> NO3 + Cl                                                                         ', & ! index 699
     '         ClNO3 --> ClO + NO2                                                                        ', & ! index 700
     '          HOCl --> LOx + OH + Cl                                                                    ', & ! index 701
     ...
     '      HCFC142b --> 2 Cl                                                                             ', & ! index 711
     '        HCFC22 --> 2 Cl                                                                             ', & ! index 712
     '         H1301 --> Br                                                                               ', & ! index 713
     '         H1211 --> Br + Cl                                                                          ', & ! index 714
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_24 = (/ &
     ...
     '        ISOPND --> HC5 + HO2 + NO2                                                                  ', & ! index 735
     '        PROPNN --> PCO + CH2O + MO2 + NO2 + CO                                                      ', & ! index 736
     ...
     '          IPMN --> 0.4 CO2 + 0.4 POx + 0.6 IMAO3 + 0.4 CH2O + 0.4 MCO3 + 0.4 NO3 + 0.6 NO2          ', & ! index 743
     '         ETHLN --> PCO + CH2O + HO2 + NO2 + CO                                                      ', & ! index 744
     '          DHDC --> GLYX + MGLY + 2 OH                                                               ', & ! index 745
     '         HPALD --> 1.89 PCO + 0.11 GLYC + 0.5 MGLY + 0.39 HAC + 0.11 MCO3 + 0.89 HO2 + 2 OH + 1.89 C', & ! index 746
     '          ISN1 --> 0.25 GLYX + 0.5 GLYC + 0.25 MGLY + 0.5 HAC + CH2O + HO2 + NO2                    ', & ! index 747
